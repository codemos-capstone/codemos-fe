...
<head>
    <title>Code coverage report for split.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="index.html">All files</a> split.js</h1>
        <div class='clearfix'>
            
            <div class='fl pad1y space-right2'>
                <span class="strong">97.36% </span>
                <span class="quiet">Statements</span>
                <span class='fraction'>222/228</span>
            </div>
            ...
            <div class='fl pad1y space-right2'>
                ...
                <span class='fraction'>94/105</span>
            </div>
            ...
            <div class='fl pad1y space-right2'>
                ...
                <span class='fraction'>201/207</span>
            </div>
...
<a name='L416'></a><a href='#L416'>416</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">1x</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import ace from 'ace-builds';
...
&nbsp;
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (this.props.debounceChangePeriod) {
<span class="cstat-no" title="statement not covered" >      this.onChange = this.debounce(this.onChange, this.props.debounceChangePeriod);</span>
    }
    split.forEach((editor, index) =&gt; {
      ...
      editor.setValue(defaultValueForEditor === undefined ? valueForEditor : <span class="branch-1 cbranch-no" title="branch not covered" >defaultValueForEditor,</span> cursorStart);
...
&nbsp;
    if (nextProps.orientation !== oldProps.orientation) {
      split.setOrientation(nextProps.orientation === 'below' ? <span class="branch-0 cbranch-no" title="branch not covered" >split.BELOW </span>: split.BESIDE);
    }
&nbsp;
    split.forEach((editor, index) =&gt; {
...
<span class="cstat-no" title="statement not covered" >          editor.setKeyboardHandler(null);</span>
        }
      }
...
&nbsp;
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (nextProps.height !== this.props.height || nextProps.width !== this.props.width) {
<span class="cstat-no" title="statement not covered" >      this.editor.resize();</span>
    }
  }
&nbsp;
